...
> 가리키며 push를 완료했다. 두 GitHub Release는 `2026-08-14 KST`에 Pre-release로
> 공개했으며 Latest release가 아니다.
...
Release도 올바른 tag, 제목과 본문으로 `2026-08-14 KST`에 Pre-release 공개를
완료했으며 Latest release로 지정하지 않았다.
